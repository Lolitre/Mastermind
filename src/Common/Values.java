...
public class Values {
    ...
    public static List<char[]> Stack;
    public static String colors;
    public static String positions;
    public static int valid1 = 0;
    public static int valid2 = 0;
    public static int[] vcolors = new int[Values.Mlenght];
    public static int[] bpos = new int[Values.Mlenght];
